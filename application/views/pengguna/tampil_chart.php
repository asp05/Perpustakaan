<h2>Daftar Pinjam</h2>
<form action="<?php echo base_url()?>pengguna/pinjam/ubah_cart" method="post" name="frmShopping" id="frmShopping" class="form-horizontal" enctype="multipart/form-data">
<?php
...
<td><a href="<?php echo base_url()?>pengguna/pinjam/hapus/<?php echo $item['rowid'];?>" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove"></i></a></td>
<?php endforeach; ?>
</tr>
<tr>
...
<a href="<?php echo base_url()?>pengguna/pinjam/proses_order"  class ='btn btn-sm btn-primary'>Check Out</a>
</tr>
...
<?php
		...
		{
			echo "<h3>Keranjang Pinjam masih kosong</h3>";	
		}	
?>
</form>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
      	<form method="post" action="<?php echo base_url()?>pengguna/pinjam/hapus/all">
